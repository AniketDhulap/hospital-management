...
namespace Hospital_Management_System_Application
{
    public partial class Form3 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Enter the Doctor Ref No....");
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        {
                                                                            MessageBox.Show("Choose Qualification From Boxx");
                                                                        }
                                                                        else
                                                                        {
        ...
        {
            if (doctor_Ref_NoTextBox.Text == "" || first_NameTextBox.Text == "" || middle_NameTextBox.Text == "" || last_NameTextBox.Text == "" || e_mail_AddressTextBox.Text == "" || genderComboBox.Text == "" || dOBDateTimePicker.Text == "" || area_CodeComboBox.Text == "" || marital_StatusComboBox.Text == "" || contact_NoTextBox.Text == "" || addressTextBox.Text == "" || postal_CodeTextBox.Text == "" || comboBoxCountry.Text == "" || comboBoxstate.Text == "" || cityTextBox.Text == "" || dateDateTimePicker.Text == "" || qualificationComboBox.Text == "")
            {
        ...
        {
            DialogResult iExit;
            iExit = MessageBox.Show("Confirm if you want to close the doctor page", "Hospital Management System", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        {
            DialogResult iExit;
            iExit = MessageBox.Show("Confirm if you want to exit form application", "Hospital Management System", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (iExit == DialogResult.Yes)
            {
                Application.Exit();
            }
        ...
        private void doctor_Ref_NoTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(this.doctor_Ref_NoTextBox , "Enter sequencially and Correct Ref No");
                return;
            }
        }
        ...
        private void KP10(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void KP11(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void KP12(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void marital_StatusComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(this.marital_StatusComboBox, "Plzzz provide the correct Status from boxx....");
                return;
            }
        ...
        {
            string pattern = @"\D+";
            if (Regex.IsMatch(qualificationComboBox.Text, pattern))
            {
                errorProvider1.Clear();
            }
            else
            {
                errorProvider1.SetError(this.qualificationComboBox, "Plzzz provide the correct Qualification......");
                return;
            }
        }
